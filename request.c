...
void requestServeDynamic(Statistics_Shit fd, char *filename, char *cgiargs)
{
...
void requestServeStatic(Statistics_Shit fd, char *filename, int filesize)
{
   int srcfd;
   ...
   Rio_writen(fd.reqFd, srcp, filesize);
